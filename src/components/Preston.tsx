            ...
            <div className="row">
              <div className="col-xl-12 col_padding">
                <div className="breadcrumb1__content text-center">
                  <h3 className="breadcrumb1__title">Preston Task Trainers</h3>
                  <div className="breadcrumb1__list">
                    ...
                    <span>
                      <span>Preston Task Trainers</span>
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="col-lg-6 col_padding">
                <div className="heading1">
                  <h2 className="heading1__title mb-30">
                    Preston <span>Task Trainers</span>
                  </h2>
                  <p>
                    Preston task trainers combine robust construction with
                    accessible, user-friendly design to support a broad range of
                    procedural training needs. From airway and respiratory
                    skills to patient assessment and invasive procedure
                    practice, these trainers help institutions standardize
                    training, streamline skill development, and elevate learner
                    confidence.
                  </p>
