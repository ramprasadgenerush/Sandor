              ...
              <div className="col-xl-12 col_padding">
                <div className="breadcrumb1__content text-center">
                  ...
                  <div className="breadcrumb1__list">
                    ...
                    <span>
                      <span>True Corp Task Trainers</span>
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="col-lg-6 col_padding">
                <div className="heading1">
                  <h2 className="heading1__title mb-30">
                    True Corp <span>Task Trainers</span>
                  </h2>
                  <p>
                    True Corp offers highly specialized trainers focused on core
                    clinical skills. These task trainers are ideal for
                    developing foundational competencies in areas like injection
                    techniques, catheter placement, suturing, and emergency
                    procedures. Their intuitive design and realistic simulation
                    features make them effective tools for skill mastery and
                    learner engagement.
                  </p>
